...
public class TransferResult  implements java.io.Serializable {
    ...
    /**
     * Gets the accountNumber value for this TransferResult.
     * 
    ...
    /**
     * Sets the accountNumber value for this TransferResult.
     * 
     * @param accountNumber
     */
    ...
    /**
     * Gets the status value for this TransferResult.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this TransferResult.
     * 
     * @param status
     */
    ...
    /**
     * Gets the transactionNumber value for this TransferResult.
     * 
    ...
    /**
     * Sets the transactionNumber value for this TransferResult.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://propay.com/MS/types", "TransferResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://propay.com/MS/types", "TransactionNumber"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
